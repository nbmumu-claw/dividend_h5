...
export interface GridPrefs {
  ...
  sectorOrder: string[]
  stockOrder: string[]
  cfg: { buyStep: number; buyCount: number; sellStep: number; sellCount: number; lowerTolerance: number; upperTolerance: number }
...
const DEFAULT_GRID_PREFS: GridPrefs = {
  ...
  stockOrder: [],
  cfg: { buyStep: 0.005, buyCount: 4, sellStep: 0.005, sellCount: 4, lowerTolerance: 0.005, upperTolerance: 0.005 },
