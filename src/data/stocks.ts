...
export const STATIC_STOCKS: Stock[] = [
  ...
  { sector: '电力', name: '中国核电', code: '601985', price: 8.71, dividendPerShare: 0.18, yieldRate: 2.3, confirmed: false, targetYield: 4.0, targetPrice: 5.0, price2026: 8.71, change2026: 0 },
  ...
  { sector: '电力', name: '国投电力', code: '600886', price: 13.41, dividendPerShare: 0.5081, yieldRate: 3.73, confirmed: false, targetYield: 4.0, targetPrice: 12.5, price2026: 13.15, change2026: 1.98 },
  ...
  { sector: '电力', name: '国电电力', code: '600795', price: 4.8, dividendPerShare: 0.241, yieldRate: 4.79, confirmed: false, targetYield: 5.0, targetPrice: 4.6, price2026: 5.02, change2026: -4.38 },
  ...
  { sector: '银行', name: '成都银行', code: '601838', price: 17.43, dividendPerShare: 0.921, yieldRate: 5.28, confirmed: false, targetYield: 5.0, targetPrice: 18.4, price2026: 16.24, change2026: 7.33 },
  { sector: '银行', name: '宁波银行', code: '002142', price: 30.25, dividendPerShare: 1.2, yieldRate: 3.31, confirmed: false, targetYield: 4.5, targetPrice: 22.22, price2026: 28.15, change2026: 7.46 },
  { sector: '银行', name: '江苏银行', code: '600919', price: 10.78, dividendPerShare: 0.564, yieldRate: 5.1, confirmed: false, targetYield: 5.0, targetPrice: 11.0, price2026: 10.46, change2026: 3.06 },
  ...
  { sector: '白酒', name: '贵州茅台', code: '600519', price: 1453.96, dividendPerShare: 52, yieldRate: 3.85, confirmed: false, targetYield: 4.0, targetPrice: 1400.0, price2026: 1426.0, change2026: 1.96 },
  { sector: '白酒', name: '五粮液', code: '000858', price: 102.07, dividendPerShare: 5.16, yieldRate: 5.68, confirmed: false, targetYield: 5.0, targetPrice: 116.0, price2026: 107.9, change2026: -5.4 },
  { sector: '白酒', name: '泸州老窖', code: '000568', price: 102.51, dividendPerShare: 5.775, yieldRate: 5.66, confirmed: false, targetYield: 5.0, targetPrice: 116.0, price2026: 118.0, change2026: -13.13 },
  ...
  { sector: '中药', name: '羚锐制药', code: '600285', price: 21.68, dividendPerShare: 1.1, yieldRate: 4.61, confirmed: false, targetYield: 6.0, targetPrice: 16.67, price2026: 21.72, change2026: -0.18 },
  ...
  { sector: '能源', name: '陕西煤业', code: '601225', price: 25.23, dividendPerShare: 0.948, yieldRate: 4.36, confirmed: false, targetYield: 5.0, targetPrice: 22.0, price2026: 21.62, change2026: 16.7 },
...
{ sector: '其他', name: '分众传媒', code: '002027', price: 6.47, dividendPerShare: 0.34, yieldRate: 5.41, confirmed: false, targetYield: 5.0, targetPrice: 7.0, price2026: 7.24, change2026: -10.64 },
  { sector: '其他', name: '伊利股份', code: '600887', price: 26.14, dividendPerShare: 1.38, yieldRate: 5.16, confirmed: false, targetYield: 5.0, targetPrice: 27.0, price2026: 28.61, change2026: -8.63 },
]
