...
export const DEFAULT_SECTORS = ['电力', '银行', '保险', '能源', '通讯', '白色家电', '中药', '运输', '白酒', '红利基金', '美股指数', '其他']
...
export const STATIC_STOCKS: Stock[] = [
  ...
  { sector: '电力', name: '中国核电', code: '601985', price: 8.71, dividendPerShare: 0.18, yieldRate: 2.3, confirmed: true, targetYield: 4.0, targetPrice: 5.0, price2026: 8.71, change2026: 0 },
  { sector: '电力', name: '长江电力', code: '600900', price: 26.4, dividendPerShare: 1.0, yieldRate: 3.79, confirmed: true, targetYield: 4.0, targetPrice: 25.0, price2026: 27.28, change2026: -3.23 },
  { sector: '电力', name: '国投电力', code: '600886', price: 13.41, dividendPerShare: 0.5081, yieldRate: 3.73, confirmed: true, targetYield: 4.0, targetPrice: 12.5, price2026: 13.15, change2026: 1.98 },
  { sector: '电力', name: '川投能源', code: '600674', price: 14.65, dividendPerShare: 0.5, yieldRate: 3.41, confirmed: true, targetYield: 4.0, targetPrice: 12.5, price2026: 13.99, change2026: 4.72 },
  { sector: '电力', name: '内蒙华电', code: '600863', price: 5.0, dividendPerShare: 0.22, yieldRate: 4.4, confirmed: true, targetYield: 5.5, targetPrice: 4.0, price2026: 4.45, change2026: 12.36 },
  { sector: '电力', name: '国电电力', code: '600795', price: 4.8, dividendPerShare: 0.241, yieldRate: 4.79, confirmed: true, targetYield: 5.0, targetPrice: 4.6, price2026: 5.02, change2026: -4.38 },
  ...
  { sector: '银行', name: '中国银行', code: '601988', price: 5.65, dividendPerShare: 0.2263, yieldRate: 4.25, confirmed: true, targetYield: 5.0, targetPrice: 4.8, price2026: 5.67, change2026: -0.35 },
  ...
  { sector: '银行', name: '成都银行', code: '601838', price: 17.43, dividendPerShare: 0.921, yieldRate: 5.28, confirmed: true, targetYield: 5.0, targetPrice: 18.4, price2026: 16.24, change2026: 7.33 },
  ...
  { sector: '白色家电', name: '格力电器', code: '000651', price: 37.34, dividendPerShare: 3.0, yieldRate: 8.03, confirmed: true, targetYield: 6.0, targetPrice: 50.0, price2026: 40.76, change2026: -8.39 },
  ...
  { sector: '中药', name: '羚锐制药', code: '600285', price: 21.68, dividendPerShare: 1.1, yieldRate: 4.61, confirmed: true, targetYield: 6.0, targetPrice: 16.67, price2026: 21.72, change2026: -0.18 },
  ...
  { sector: '运输', name: '大秦铁路', code: '601006', price: 5.2, dividendPerShare: 0.22, yieldRate: 4.23, confirmed: true, targetYield: 5.0, targetPrice: 4.4, price2026: 5.16, change2026: 0.78 },
  ...
  { sector: '能源', name: '陕西煤业', code: '601225', price: 25.23, dividendPerShare: 0.948, yieldRate: 4.36, confirmed: true, targetYield: 5.0, targetPrice: 22.0, price2026: 21.62, change2026: 16.7 },
...
{ sector: '其他', name: '分众传媒', code: '002027', price: 6.47, dividendPerShare: 0.34, yieldRate: 5.41, confirmed: true, targetYield: 5.0, targetPrice: 7.0, price2026: 7.24, change2026: -10.64 },
  { sector: '其他', name: '伊利股份', code: '600887', price: 26.14, dividendPerShare: 1.38, yieldRate: 5.16, confirmed: true, targetYield: 5.0, targetPrice: 27.0, price2026: 28.61, change2026: -8.63 },
]
