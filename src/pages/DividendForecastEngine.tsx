...
export default function DividendForecastEngine() {
  ...
  const runFor = async (keyword: string) => {
    ...
    setLoading(true); setError(''); setResult(null); setMatches([]); setPayoutChoice('auto')
    try {
      if (!/^\d{6}$/.test(code)) {
