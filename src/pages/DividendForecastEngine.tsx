...
export default function DividendForecastEngine() {
  ...
  return <main className="forecast-page"><div className="forecast-shell">
    ...
    <section className="forecast-risk"><b>⚠️ 风险提示</b><span>本页为基于已披露财报、历史分红与中期息的模型估算，不代表公司分红承诺。利润、派息率、股本及分红方案均可能变化；股价波动也会改变预期股息率。仅供研究参考，不构成任何投资建议。</span></section>
